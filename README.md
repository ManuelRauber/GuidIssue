...
Required Unity Version: 6000.4.3f1
...
- Default URP 3D Template.
- Added the Build Profiles I use: `Assets/_Game/Build Profiles`
- Added the Code to build I use: `Assets/_Game/Code/Build`
